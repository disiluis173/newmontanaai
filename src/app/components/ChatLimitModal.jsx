...
const ChatLimitModal = ({ isOpen, onClose, onUnlock, blockTimeRemaining }) => {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl max-w-md w-full">
        ...
        <p className="text-gray-600 dark:text-gray-300 mb-4">
          Has alcanzado el límite de 30 mensajes por día. 
          {blockTimeRemaining && <span className="font-bold block mt-2 text-red-500">Chat bloqueado por {blockTimeRemaining}</span>}
          Ingresa la contraseña para desbloquear mensajes ilimitados.
        </p>
